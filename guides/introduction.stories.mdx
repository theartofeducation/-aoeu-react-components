...
Adding this resource/dependency to your projects will give you access to all of our common UI resources like our [Color Palette](/?path=/story/guides-colors--page), [Typography Resources](/?path=/story/guides-typography--page), [Brand and Product Logos](/?path=/story/guides-logos--page) and [Reusable Components](/?path=/story/components-components-overview--page).
