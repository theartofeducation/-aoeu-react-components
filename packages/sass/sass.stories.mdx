...
This package contains a collection of shared/common [Sass](https://sass-lang.com/) modules for consumption by dependent projects for the maintenance and reuse of common styling across AOEU's various web projects.
